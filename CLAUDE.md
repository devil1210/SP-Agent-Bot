...
This project is indexed by GitNexus as **SPbot** (296 symbols, 596 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
